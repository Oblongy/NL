...
drop policy if exists "Service role has full access to remarks" on public.game_player_remarks;
...
drop trigger if exists game_player_remarks_touch_updated_at on public.game_player_remarks;
