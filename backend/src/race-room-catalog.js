export const DEFAULT_RACE_ROOMS = [
  { id: 1, name: "Team Rivals Strip", type: "team", maxPlayers: 8, tcpRoomType: 5, systemMessages: 0 },
  { id: 2, name: "Tournament Strip", type: "tournament", maxPlayers: 32, tcpRoomType: 5, systemMessages: 0 },
  { id: 3, name: "Bracket King of the Hill Strip", type: "bracket_koth", maxPlayers: 16, tcpRoomType: 3, systemMessages: 0 },
  { id: 4, name: "H2H King of the Hill Strip", type: "h2h_koth", maxPlayers: 8, tcpRoomType: 6, systemMessages: 0 },
  { id: 5, name: "Newbie Rivals Strip", type: "newbie", maxPlayers: 20, tcpRoomType: 5, systemMessages: 1 },
];
